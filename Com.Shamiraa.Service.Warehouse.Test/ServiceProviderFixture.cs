    ...
    public class ServiceProviderFixture
    {
        ...
        public ServiceProviderFixture()
        {
            IConfigurationRoot configuration = new ConfigurationBuilder()
                ...
                {
                    new KeyValuePair<string, string>(Constant.SECRET, "ShamiraaDEVELOPMENT"),
                    ...
                    new KeyValuePair<string, string>(Constant.DEFAULT_CONNECTION, "Server=localhost,1401;Database=com.Shamiraa.db.warehouse.service.test;User Id=sa;Password=Standar123.;MultipleActiveResultSets=True;"),
