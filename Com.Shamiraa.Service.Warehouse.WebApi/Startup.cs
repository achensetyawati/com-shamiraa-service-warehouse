...
using Com.Shamiraa.Service.Warehouse.Lib.Serializers;
using Com.Shamiraa.Service.Warehouse.Lib.Services;
//using Com.Shamiraa.Service.Purchasing.Lib.ViewModels.IntegrationViewModel;
//using Com.Shamiraa.Service.Purchasing.Lib.ViewModels.PurchaseOrder;
//using Com.Shamiraa.Service.Purchasing.Lib.ViewModels.UnitPaymentCorrectionNoteViewModel;
//using Com.Shamiraa.Service.Purchasing.Lib.ViewModels.UnitReceiptNote;
...
using System.Text;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.GarmentExternalPurchaseOrderFacade.Reports;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.GarmentUnitDeliveryOrderReturFacades;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.GarmentReceiptCorrectionFacades;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.MonitoringCentralBillReceptionFacades;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.MonitoringCentralBillExpenditureFacades;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.MonitoringCorrectionNoteReceptionFacades;
using FluentScheduler;
using Com.Shamiraa.Service.Warehouse.WebApi.SchedulerJobs;
using Com.Shamiraa.Service.Warehouse.Lib.Utilities.CacheManager;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.MonitoringCorrectionNoteExpenditureFacades;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.GarmentPOMasterDistributionFacades;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.GarmentReports;
...
using System;
using Com.Shamiraa.Service.Warehouse.Lib.Interfaces.TransferInterfaces;
...
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.PRMasterValidationReportFacade;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.GarmentExternalPurchaseOrderFacades.Reports;
//using Com.Shamiraa.Service.Purchasing.Lib.Facades.GarmentSupplierBalanceDebtFacades;

namespace Com.Shamiraa.Service.Warehouse.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "ShamiraaWareHouse API", Version = "v1" });
