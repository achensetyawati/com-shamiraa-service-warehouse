...
using Com.Shamiraa.Service.Warehouse.Lib.PDFTemplates;
using Com.Shamiraa.Service.Warehouse.Lib.Interfaces.PkbjInterfaces;
//using Com.Shamiraa.Service.Purchasing.Lib.PDFTemplates;

namespace Com.Shamiraa.Service.Warehouse.WebApi.Controllers.v1.PkpbjControllers
{
    ...
    public class PkpbjByUserController : Controller
    {
        ...
        public IActionResult GetPackingList(int page = 1, int size = 25, string order = "{}", string keyword = null, string filter = "{}")
        {
            ...
            try
            {
                ...
                var Data = facade.ReadPackingList(page, size, order, keyword, filter);
        ...
        [HttpGet("packingRTP")]
        public IActionResult GetPackingRTP(int page = 1, int size = 25, string order = "{}", string keyword = null, string filter = "{}")
        {
            identityService.Username = User.Claims.Single(p => p.Type.Equals("username")).Value;
